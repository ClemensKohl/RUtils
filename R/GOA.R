...
#' @export
load_gene_set <- function(set = "CellMarker", org) {
...
#' @export
filter_gene_sets <- function(gene_sets, min_size = 10, max_size = 500) {
...
#'
#' @export
perform_goa <- function(gois, gene_sets, universe, min_size, max_size) {
...
#' @export
plot_goa_res <- function(goa_res, nres = 3) {
